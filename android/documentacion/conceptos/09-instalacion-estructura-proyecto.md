...
> 📘 **¿Quieres el paso a paso para abrir un proyecto, crear un emulador, ejecutar en tu móvil y leer los errores?** Está en la [Guía: cómo abrir, ejecutar y probar una app](../guias/01-ejecutar-la-app.md). Este documento explica **qué es** cada pieza; la guía explica **cómo se usa**.
