...
- [Nivel 4 — ejercicio 4.2](../ejercicios/04-nivel-4-toast-asynctask-animaciones-transiciones.md) (`AsyncTask`) y [Nivel 6 — ejercicio 6.3](../ejercicios/06-nivel-6-dialogos-y-room.md) (`AppExecutors`)
