...
|---|---|---|---|---|---|
| [EjemploFragmentos](../proyectos/EjemploFragmentos.md) | `FragmentContainerView` | ✅ (`FragmentoAbajo`) | ✅ `IControlFragmentos` (2 métodos) | ❌ | ✅ Completo, sigue el PDF del curso casi al 100% |
| [EjercicioFragmentos](../proyectos/EjercicioFragmentos.md) | `FragmentContainerView` | ✅ (`Fragmento2`, `Fragmento3`) | ✅ `IControlFragmentos` + `instanceof` | ✅ `ArrayList<Persona>` | ✅ Completo, el más avanzado de los tres |
| [FragmentosNombres](../proyectos/FragmentosNombres.md) | `LinearLayout` (forma clásica) | ✅ (`FragmentoMedio`) | ✅ `IControlFragmentos` (1 método) | ❌ | ⚠️ Tenía dos bugs reales de los descritos en §8 (ya corregidos) |
...
- [Nivel 5 — ejercicios 5.1 a 5.4](../ejercicios/05-nivel-5-fragmentos.md) (fragmento + interfaz, menú y formulario de tres fragmentos) y [Simulacro D](../ejercicios/08-simulacros-de-examen.md)
