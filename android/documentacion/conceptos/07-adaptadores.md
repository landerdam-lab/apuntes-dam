...
- [Nivel 3 — Adaptadores](../ejercicios/03-nivel-3-adaptadores.md): `ListView`/`GridView` con `BaseAdapter` (3.1–3.3), `Spinner` personalizado (3.4), Glide (3.5), `RecyclerView` (3.6) y Picasso (3.7)
- [Simulacro A — Menú de adaptadores](../ejercicios/08-simulacros-de-examen.md)
