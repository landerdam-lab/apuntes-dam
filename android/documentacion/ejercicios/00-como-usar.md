...
`Desktop\android\proyectos-zip\EjemploDialogoPersonalizado-con-soluciones.zip`
...
![menu de ejercicios](../img/n0-menu-ejercicios.png)
...
4. Anota **qué error cometiste**. Los errores se repiten: [03 — Errores comunes](../guias/03-errores-comunes.md).
...
> **Nota sobre los `import`:** en los documentos no aparecen los `import` para que el código se lea mejor. Cuando algo salga en rojo, pon el cursor encima y pulsa **Alt + Intro → Import class**. Tampoco se repite en cada ejemplo el bloque de `EdgeToEdge` + insets: verás `// ... (bloque de insets de siempre)`. Es el que ya conoces de todos tus proyectos ([01 §5](../conceptos/01-fundamentos-bundle-intent-ciclo-vida.md)).
...
- Si la app se cierra al abrirla, **mira Logcat** ([Guía 01 §6](../guias/01-ejecutar-la-app.md)).
...
## Ver también
- [INDICE](../INDICE.md) — toda la documentación.
- [02 — Glosario](../guias/02-glosario.md) — si un término no lo conoces.
