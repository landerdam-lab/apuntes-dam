...
**Antes de empezar, lee:** [00 — Conceptos básicos de programación](../conceptos/00-programacion-basica.md), [01 — Fundamentos](../conceptos/01-fundamentos-bundle-intent-ciclo-vida.md) y [04 — Toast personalizado](../conceptos/04-toast-personalizado.md) (solo el `Toast` normal del principio).
...
### 🎯 Qué practicas
Métodos con parámetros y retorno, `if`, `for`, `ArrayList` ([00 §3, §4, §8](../conceptos/00-programacion-basica.md)).
...
### 🎯 Qué practicas
Layout básico, `findViewById`, `setOnClickListener` con clase anónima ([01 §1, §5, §6](../conceptos/01-fundamentos-bundle-intent-ciclo-vida.md)).
...
### 🎯 Qué practicas
`EditText.getText().toString()`, `Toast.makeText(getApplicationContext(), …)`, `if/else` ([04 §1](../conceptos/04-toast-personalizado.md)).
...
### 🎯 Qué practicas
`Intent` explícito, `Bundle`, `putString` / `getString`, `intent.putExtras`, declarar Activities en el manifiesto ([01 §2.2, §3, §4](../conceptos/01-fundamentos-bundle-intent-ciclo-vida.md), [11](../conceptos/11-intent-en-profundidad.md)).
