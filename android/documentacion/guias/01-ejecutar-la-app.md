...
Detalle de qué es cada cosa: [09 — Instalación y estructura de proyecto](../conceptos/09-instalacion-estructura-proyecto.md).
...
|---|---|
| ![principal](../img/01-pantalla-principal.png) | ![login](../img/02-dialogo-login.png) |
...
![registro vacío](../img/03-registro-vacio.png)

**2. Escribe `Almi`, `Almi123` y en Re-password `Almi12` (mal).** El campo se pone rojo:

![no coincide](../img/04-password-no-coincide.png)

> En la **versión original** del proyecto, *Nuevo* se desactiva aquí (aparece en gris). En la versión con las mejoras del [nivel 7](../ejercicios/07-nivel-7-mejoras-del-proyecto.md) además se vigila el campo Password.

**3. Añade el `3` que falta.** Coinciden: el campo vuelve a blanco y *Nuevo* se activa:

![coinciden](../img/05-password-coincide.png)

Pulsa **Nuevo** y el usuario aparece en la lista:

![usuario creado](../img/06-usuario-creado.png)
...
- [09 — Instalación y estructura de proyecto](../conceptos/09-instalacion-estructura-proyecto.md)
