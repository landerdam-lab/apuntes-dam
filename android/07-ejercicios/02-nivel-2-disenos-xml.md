...
**Antes de empezar, lee:** [02 — Diseño basado en pesos](../02-conceptos/02-diseno-basado-en-pesos.md), [03 — ConstraintLayout](../02-conceptos/03-constraintlayout.md) y [15 — Drawables: formas y selectores](../02-conceptos/15-drawables-formas-y-selectores.md).
...
### 🎯 Qué practicas
`LinearLayout` horizontal, `layout_weight`, la regla de `0dp` ([02 §2](../02-conceptos/02-diseno-basado-en-pesos.md)).
...
![pesos](../adjuntos/img/n2-1-pesos.png)
...
### 🎯 Qué practicas
Anidar `LinearLayout`, alternar orientación vertical/horizontal, pesos en cada nivel ([02 §3.1](../02-conceptos/02-diseno-basado-en-pesos.md)).
...
![rejilla](../adjuntos/img/n2-2-rejilla.png)
...
### 🎯 Qué practicas
Restricciones a `parent` y a otras vistas, márgenes ([03 §2, §3](../02-conceptos/03-constraintlayout.md)).
...
![ficha](../adjuntos/img/n2-3-ficha.png)
...
**🚀 Reto extra:** centra el nombre en horizontal usando `layout_constraintHorizontal_bias` ([03 §4](../02-conceptos/03-constraintlayout.md)).
...
### 🎯 Qué practicas
Pesos anidados, `style` con herencia, `dimens.xml`, `<shape>` y `<selector>` ([02](../02-conceptos/02-diseno-basado-en-pesos.md), [15](../02-conceptos/15-drawables-formas-y-selectores.md), proyecto [EjercicioDiseno](../05-proyectos-alumno/EjercicioDiseno.md)).
...
![menu de diseno](../adjuntos/img/n2-4-menu-diseno.png)
...
- Usar `android:src` en vez de `android:background` con una imagen con transparencia ([03 §9](../02-conceptos/03-constraintlayout.md)).
