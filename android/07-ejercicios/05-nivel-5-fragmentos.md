...
**Antes de empezar, lee:** [16 — Fragmentos](../02-conceptos/16-fragmentos.md) y los proyectos [EjemploFragmentos](../05-proyectos-alumno/EjemploFragmentos.md) y [EjercicioFragmentos](../05-proyectos-alumno/EjercicioFragmentos.md), de donde salen estos ejercicios (y el PDF `8-Fragmentos.pdf`).
...
![inicio](../adjuntos/img/n5-1-fragmentos-inicio.png)

### 🎯 Qué practicas
`Fragment`, `onCreateView`, `FragmentContainerView`, `getSupportFragmentManager().beginTransaction().add(...).commit()` ([16](../02-conceptos/16-fragmentos.md)).
...
![texto](../adjuntos/img/n5-2-fragmentos-texto.png)

### 🎯 Qué practicas
Interfaz Fragment ↔ Activity, `onAttach` + casting, `newInstance(Bundle)`, `setArguments` / `getArguments`, `replace` ([16 §4–§7](../02-conceptos/16-fragmentos.md)).
...
|---|---|
| ![menu](../adjuntos/img/n5-3-fragmentos-menu.png) | ![verde](../adjuntos/img/n5-3-fragmentos-verde.png) |
...
![fichas](../adjuntos/img/n5-4-fichas.png)

### 🎯 Qué practicas
Tres fragmentos coordinados por la Activity, `Serializable` en un `Bundle`, `newInstance`, `BaseAdapter` en un `GridView`, `instanceof` en `onAttach`, `onDetach` ([16 §5–§8](../02-conceptos/16-fragmentos.md)).
