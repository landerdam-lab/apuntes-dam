...
- [Nivel 1 — ejercicios 1.2 a 1.5](../07-ejercicios/01-nivel-1-java-y-primera-app.md) (botón, `EditText`, `Toast`, `Intent`, `putExtra`)
- [Guía: ejecutar la app en emulador o móvil](../01-guias/01-ejecutar-la-app.md)
