...
- [Nivel 4 — ejercicio 4.2](../07-ejercicios/04-nivel-4-toast-asynctask-animaciones-transiciones.md): barra de progreso con `AsyncTask`
- [Simulacro B](../07-ejercicios/08-simulacros-de-examen.md): menú de diseño con toast, `AsyncTask` y frames
