...
- El módulo **"Frame By Frame"** del curso enseña la forma **nativa** de Android de animar fotograma a fotograma, sin ningún hilo propio: `AnimationDrawable`. Ninguno de tus proyectos (`codigo/proyectos-alumno/`) llega a implementar este ejercicio concreto — se documenta aquí igualmente, por completitud, tal como lo plantea el material del curso.
