...
> Proyecto donde se usan: [EjemploDialogoPersonalizado](../05-proyectos-alumno/EjemploDialogoPersonalizado.md) (`RegisterActivity`).
...
- [Nivel 7 — ejercicio 7.4](../07-ejercicios/07-nivel-7-mejoras-del-proyecto.md) (arreglar el `TextWatcher` y la validación)
- [Nivel 3 — ejercicios 3.1 y 3.3](../07-ejercicios/03-nivel-3-adaptadores.md) (clic en una fila)
