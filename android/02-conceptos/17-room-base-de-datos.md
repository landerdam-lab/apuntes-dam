...
> Proyecto donde se usa: [EjemploDialogoPersonalizado](../05-proyectos-alumno/EjemploDialogoPersonalizado.md). PDF del curso: `adjuntos/pdfs/1-DialogSQLitePersonalizado.pdf`.
...
- [Nivel 6 — ejercicio 6.3](../07-ejercicios/06-nivel-6-dialogos-y-room.md) (app de notas con Room) y [Simulacro C — Login y registro](../07-ejercicios/08-simulacros-de-examen.md)
- [Nivel 7 — ejercicio 7.5](../07-ejercicios/07-nivel-7-mejoras-del-proyecto.md) (rechazar usuarios repetidos con una `@Query` nueva)
