...
> Proyecto donde se usan los dos: [EjemploDialogoPersonalizado](../05-proyectos-alumno/EjemploDialogoPersonalizado.md). PDF del curso: `adjuntos/pdfs/1-DialogSQLitePersonalizado.pdf`.
...
- [Nivel 6 — ejercicios 6.1 y 6.2](../07-ejercicios/06-nivel-6-dialogos-y-room.md) (`AlertDialog` y `DialogFragment` de login)
- [Nivel 7 — ejercicios 7.1 y 7.3](../07-ejercicios/07-nivel-7-mejoras-del-proyecto.md) (mensaje del diálogo y aviso del login)
