...
Este documento cubre un tema que se usa a fondo en [EjercicioDiseno](../05-proyectos-alumno/EjercicioDiseno.md) pero que no había quedado documentado: cómo se construyen fondos, marcos y estados de botón **sin usar ninguna imagen**, solo con XML.
...
- [../proyectos/EjercicioDiseno](../05-proyectos-alumno/EjercicioDiseno.md) — dónde se usan estos drawables y estilos en la práctica.

## 🏋️ Practica esto

- [Nivel 2 — ejercicio 2.4](../07-ejercicios/02-nivel-2-disenos-xml.md) (botón con forma y estado pulsado)
