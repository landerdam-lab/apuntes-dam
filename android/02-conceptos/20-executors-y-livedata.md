...
> Proyecto donde se usan: [EjemploDialogoPersonalizado](../05-proyectos-alumno/EjemploDialogoPersonalizado.md). Complementa a [12 — Hilos, a fondo](12-hilos-en-profundidad.md) y [17 — Room](17-room-base-de-datos.md).
...
- [Nivel 7 — ejercicio 7.2](../07-ejercicios/07-nivel-7-mejoras-del-proyecto.md) (arreglar el orden de `AppExecutors`)
- [Nivel 6 — ejercicio 6.3](../07-ejercicios/06-nivel-6-dialogos-y-room.md) (app de notas: `LiveData` + `AppExecutors`)
